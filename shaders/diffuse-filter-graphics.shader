    ...
    texCoord: vec2<f32>) -> FilterResult
{
    ...
    result.mOutput1 = vec4<f32>(ret1.xyz, 1.0f);
    result.mOutput2 = vec4<f32>(ret2.xyz, 1.0f);
    result.mOutput3 = vec4<f32>(ret3.xyz, 1.0f);
    result.mOutput4 = vec4<f32>(ret4.xyz, 1.0f);
