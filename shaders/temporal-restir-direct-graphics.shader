...
fn fs_main(in: VertexOutput) -> FragmentOutput 
{
    ...
    out.directSunOutput = vec4<f32>(result.mRadiance, 1.0f);
    ...
    out.specularOutput = specularResult.mRadiance;
    ...
    randomResult: RandomResult) -> DirectSunLightResult
{
    ...
    {
        var fDirectSunConeDP: f32 = max(dot(sampleRayDirection, defaultUniformData.mLightDirection.xyz) - fDirectSunLightConeAngle, 0.0f);
        ...
        let scatteringResult: ScatteringResult = IntegrateScattering(
            ...
            defaultUniformData.mLightDirection.xyz,
            defaultUniformData.mLightRadiance.xyz * 0.05f,
            transmittance);
        var sampleRadiance: vec3<f32> = scatteringResult.radiance * scatteringResult.transmittance * fDirectSunConeDP * fDP;
