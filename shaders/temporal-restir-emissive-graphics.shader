...
fn fs_main(in: VertexOutput) -> FragmentOutput 
{
    ...
    out.emissiveRadiance = emissiveResult.mRadiance;
    ...
    randomResult: RandomResult) -> EmissiveLightResult
{
    ...
    sampleRadiance = ((sampleRadiance * fDP * fJacobian) / fDistanceSquared) / PI;
    ...
    // clamp reservoir
    if(updateResult.mReservoir.z > 8.0f)
    {
        let fPct: f32 = 8.0f / updateResult.mReservoir.z;
        updateResult.mReservoir.x *= fPct;
        updateResult.mReservoir.z = 8.0f;
    }
